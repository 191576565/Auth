			...
			$.get('resMgmt/get', {r:Math.random()*10000000000000}, function(data){
				...
				if(rs!=null){
					rs.forEach(function(e){
						if(e.lvl===1){
							temp='<tr class="treegrid-'+e.uuid+'" lvl="'+e.lvl+'"><td style="width:40px;text-align:center;"><input type="radio" name="orgRadio"/></td><td id="'+e.res_id+'">'+e.res_id+'</td><td>'+e.res_name+'</td><td>'
									+e.up_res_name+'</td><td>'+e.res_url+'</td><td>'+e.res_type+'</td><td>'+e.res_class+'</td><td>'+e.res_color+'</td><td>'+e.res_icon
									+'</td><td>-</td></tr>';
							$('#table tbody').append(temp);
						}else {
							temp='<tr class="treegrid-'+e.uuid+' treegrid-parent-'+e.res_up_uuid+'" lvl="'+e.lvl+'"><td style="width:40px;text-align:center;"><input type="radio" name="orgRadio"/></td><td id="'+e.res_id+'">'+e.res_id+'</td><td>'+e.res_name+'</td><td>'
									+e.up_res_name+'</td><td>'+e.res_url+'</td><td>'+e.res_type+'</td><td>'+e.res_class+'</td><td>'+e.res_color+'</td><td>'+e.res_icon
