...
function onEdit(index) {
	...
	$("#sys_add_div #form #role_name").val(info.role_name);
	$("#sys_add_div #form #domain_uuid").val(info.domain_uuid);
	$("#sys_add_div #form #ipt_memo").val(info.memo);
	$('.error').empty();
	layer.open({
		type: 1,
		content: $('#sys_add_div'),
